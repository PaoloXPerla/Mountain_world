...
<link rel="stylesheet" href="../../resources/css/login.css">
 ...
 <div id="modal1" class="modal">
    ...
    <img src="../../resources/multimedia/accesorios.jpg" alt="" class="responsive-img ima">
   </div>
...
<div class="row">
    <div class="col l3 m3 s12">
      <div class="card">
        <div class="card-image">
          <img src="../../resources/multimedia/accesorios.jpg"width="640" height="240" class="materialboxed">
    ...
    <div class="col l3 m3 s12">
      <div class="card">
        <div class="card-image">
          <img src="../../resources/multimedia/accesorios2.jpg" width="640" height="240">
          <span class="card-title"></span>
        </div>
        <div class="card-content">
          <p>I am a very simple card. I am good at containing small bits of information.
    ...
    <div class="col l3 m3 s12">
      <div class="card">
        <div class="card-image">
          <img src="../../resources/multimedia/accesorios3.jpg" width="640" >
          <span class="card-title"></span>
        </div>
        <div class="card-content">
          <p>I am a very simple card. I am good at containing small bits of information.
    ...
    <div class="col l3 m3 s12">
      <div class="card">
        <div class="card-image">
          <img src="../../resources/multimedia/accesorios4.jpg">
          <span class="card-title"></span>
        </div>
        <div class="card-content">
          <p>I am a very simple card. I am good at containing small bits of information.
